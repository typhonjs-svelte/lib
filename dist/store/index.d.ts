...
declare class TJSLocalStorage {
     ...
     */
    static "__#121585@#createStore"(key: string, defaultValue?: boolean): svelte_store.Writable<any>;
    /**
...
declare class TJSSessionStorage {
     ...
     * @returns {import('svelte/store').Writable} The new store.
     */
    static "__#121586@#createStore"(key: string, defaultValue?: boolean): svelte_store.Writable<any>;
    /**
