...
declare class LocalStorage {
     ...
     */
    static "__#215678@#createStore"(key: string, defaultValue?: boolean): svelte_store.Writable<any>;
    /**
...
declare class SessionStorage {
     ...
     */
    static "__#215679@#createStore"(key: string, defaultValue?: boolean): svelte_store.Writable<any>;
    /**
...
export { CompareFn, DataDerivedCreate, DataDynArray, DataDynArrayCreate, DataDynMap, DataDynMapCreate, DataFilter, DataOptions, DataSort, DerivedArrayReducer, DerivedMapReducer, DynArrayReducer, DynMapReducer, FilterFn, IDerivedReducer, IDerivedReducerCtor, IDynArrayReducerCtor, IDynMapReducerCtor, LSStore, LocalStorage, OptionsDerivedCreate, OptionsDynArrayCreate, OptionsDynMapCreate, SSStore, SessionStorage, isReadableStore, isUpdatableStore, isWritableStore, propertyStore, subscribeFirstRest, subscribeIgnoreFirst, writableDerived };
