...
function createFilterQuery(property, { caseSensitive = false } = {})
{
   let keyword = '';
   let regex;
   const storeKeyword = writable$2(keyword);
...
export { DynArrayReducer, LocalStorage, SessionStorage, createFilterQuery, isReadableStore, isUpdatableStore, isWritableStore, propertyStore, storeCallback, subscribeFirstRest, subscribeIgnoreFirst, writableDerived };
