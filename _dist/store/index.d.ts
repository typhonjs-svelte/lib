...
declare class TJSLocalStorage {
     ...
     */
    static "__#145263@#createStore"(key: string, defaultValue?: boolean): _svelte_store.Writable<any>;
    /**
...
declare class TJSSessionStorage {
     ...
     * @returns {import('#svelte/store').Writable} The new store.
     */
    static "__#145264@#createStore"(key: string, defaultValue?: boolean): _svelte_store.Writable<any>;
    /**
...
export { ArrayObjectStore, ArrayObjectStoreParams, ArrayObjectUpdateData, BaseArrayObjectEntryStore, CompareFn, CrudArrayObjectStore, CrudArrayObjectStoreParamProps, CrudArrayObjectStoreParams, CrudDispatch, DataDerivedCreate, DataDynArray, DataDynArrayCreate, DataDynMap, DataDynMapCreate, DataFilter, DataOptions, DataSort, DerivedArrayReducer, DerivedMapReducer, DynArrayReducer, DynMapReducer, FilterFn, IDerivedReducer, IDerivedReducerCtor, IDynArrayReducerCtor, IDynMapReducerCtor, KeyStore, KeyStoreOptions, ObjectEntryStore, OptionsDerivedCreate, OptionsDynArrayCreate, OptionsDynMapCreate, TJSLocalStorage, TJSSessionStorage, isReadableStore, isUpdatableStore, isWritableStore, propertyStore, storeCallback, subscribeFirstRest, subscribeIgnoreFirst, writableDerived };
